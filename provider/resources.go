...
import (
	...
	timescale "github.com/timescale/terraform-provider-timescale/shim" // Import the upstream provider

	pfbridge "github.com/pulumi/pulumi-terraform-bridge/v3/pkg/pf/tfbridge"
	"github.com/pulumi/pulumi-terraform-bridge/v3/pkg/tfbridge"
	"github.com/pulumi/pulumi-terraform-bridge/v3/pkg/tfbridge/tokens"

	"github.com/itoam/pulumi-timescale/provider/pkg/version"
)
...
const (
	...
	mainPkg = "timescale"
	// modules:
	mainMod = "index" // the timescale module
)

//go:embed cmd/pulumi-resource-timescale/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-timescale/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-timescale/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "timescale", timescale.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-timescale/provider".New
		...
		Keywords:   []string{"timescale", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/itoam/pulumi-timescale/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("timescale_", mainMod,

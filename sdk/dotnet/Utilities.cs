...
namespace Pulumi.Timescale
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/itoam/pulumi-timescale/releases/download/v${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Timescale.version.txt");
    ...
    internal sealed class TimescaleResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public TimescaleResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}

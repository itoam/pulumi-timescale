...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/pulumi-timescale/sdk(/v\\d+)?")
...
func PkgResourceDefaultOpts(opts []pulumi.ResourceOption) []pulumi.ResourceOption {
	...
	defaults = append(defaults, pulumi.PluginDownloadURL("https://github.com/itoam/pulumi-timescale/releases/download/v${VERSION}"))
	version := semver.MustParse("1.0.0-alpha.0")
